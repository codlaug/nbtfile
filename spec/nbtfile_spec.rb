...
shared_examples_for 'readers and writers' do
  ...
  a_reader_or_writer 'should handle short fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Short.new(0x4e5a) })]
  ...
  a_reader_or_writer 'should handle byte fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Byte.new(0x4e) })]
  ...
  a_reader_or_writer 'should handle string fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::String.new('hoge') })]
  ...
  a_reader_or_writer 'should handle byte array fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::ByteArray.new("\x01\x02\x03\x04\x05") })]
  ...
  a_reader_or_writer 'should handle long fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Long.new(0x0102030405060708) })]
  ...
  a_reader_or_writer 'should handle float fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Float.new("\x3f\xa0\x00\x00".unpack('g').first) })]
  ...
  a_reader_or_writer 'should handle double fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Double.new("\x3f\xf4\x00\x00\x00\x00\x00\x00".unpack('G').first) })]
  ...
  a_reader_or_writer 'should handle nested compound fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::Compound.new({
  ...
  for label, type, token, repr, pack in simple_list_types
    ...
    a_reader_or_writer "should handle lists of #{label}",
                       ...
                       [Tokens::TAG_Compound['foo', nil],
                        ...
                        Tokens::TAG_End['', nil]],
                       ['foo',
                        Types::Compound.new({ 'bar' => Types::List.new(type, values.map { |v| type.new(v) }) })]
  end
  ...
  a_reader_or_writer 'should handle lists of empty',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::List.new(Types::End, []) })]
  ...
  a_reader_or_writer 'should handle nested lists',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::List.new(Types::List, [Types::List.new(Types::Byte, [Types::Byte.new(0x4a)])]) })]
  ...
  a_reader_or_writer 'should handle int array fields',
                     ...
                     [Tokens::TAG_Compound['foo', nil],
                      ...
                      Tokens::TAG_End['', nil]],
                     ['foo',
                      Types::Compound.new({ 'bar' => Types::IntArray.new([0x1, 0x2]) })]
end
...
describe 'NBTFile::tokenize (zipped input)' do
  ...
  def check_reader_or_writer(input, tokens, _tree)
...
describe 'NBTFile::emit_uncompressed' do
  ...
  def check_reader_or_writer(output, tokens, _tree)
    io = StringIO.new
...
describe 'NBTFile::read' do
  ...
  def check_reader_or_writer(input, _tokens, tree)
    io = make_zipped_stream(input)
...
describe 'NBTFile::write' do
  ...
  def check_reader_or_writer(output, _tokens, tree)
    io = StringIO.new
    name, body = tree
